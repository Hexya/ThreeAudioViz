    ...
    constructor() {
    	...
    	for(var x=0; x<25; x++) {
    	    for(var y=0; y<25; y++) {
                ...
                //Tube
                /*mesh.position.x = Math.cos(-i * Math.PI/300) * (this.rayon);
                mesh.position.y = Math.sin(-i * Math.PI/300) * (this.rayon);
                mesh.position.z = Math.cos(-i) * this.rayon;
                  //mesh.position.z = Math.sin(-i)* (this.rayon+Math.cos(i));*/
                //3Boil
                /*mesh.position.x = Math.cos(-i * Math.PI/300) * (this.rayon+Math.cos(-i));
                mesh.position.y = Math.sin(-i * Math.PI/300) * (this.rayon-Math.cos(-i));
                mesh.position.z = Math.sin(-i)-Math.cos(-i) * this.rayon;*/
                //Ovale
                /*mesh.position.x = Math.cos(-i * Math.PI/300) * (this.rayon+Math.cos(-i));
                mesh.position.y = Math.sin(-i * Math.PI/300) * (this.rayon+Math.cos(-i));
                mesh.position.z = Math.sin(-i)-Math.cos(-i) * this.rayon;*/
